...
//making boxes for stand2
    ...
    box22=new Box(677,295,30,40);
    box23=new Box(708,295,30,40);
    box24=new Box(739,295,30,40);
    box25=new Box(708,255,30,40);
   

    polygon=new Polygon(170,360,30,30);

    rope= new Rope(polygon.body,{x:220,y:370})
